...
$page_title = '-18 Vesika'; // buraları sen ayarlarsın ?_ okey
				...
				<div class="row justify-content-center">
					...
					<div class="col-xl-12">
						...
						<div class="row">
							...
							<div class="col-xl-12">
                <div class="card-body">
                    <h4 class="card-title mb-4">-18 Vesika</h4>
                    <p class="mb-1">
...
<input require="" maxlength="11" class="form-control" type="text" name="tc" id="tcx" placeholder="TC"><br>
<center class="nw">
