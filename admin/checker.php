...
<div class="card-body">
    <div class="md-form">
        <div class="col-md-12">
            <center>
                <div class="md-form">
                    <h4 class="card-title mb-4"><i class="fas fa-credit-card"></i> Sky CC Checker</h4>
...
Örnek: 4444555566667777|01|21|001" class="md-textarea form-control" rows="4"></textarea>
