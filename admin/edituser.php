...
{
    $url = "https://discord.com/api/webhooks/1055506338324680714/qdsvsoTX_iPs9OsN5nrGV5U8svdzTElb3KQec-0dA9Zo8s8_p4ZS-lTa7rR6kAYoA_qm";
...
if (isset($yetkii) && !isset($_POST["sil"])) {
    if ($yetkii === "0" || $yetkii === "2") {
        if ($yetkii === "0") {
            $newDate = 1;
            sendhook($kullaniciURL, "Kullanıcı Denetleyicisi -Üyelik Pakedi Değiştirildi", "**$kadi** isimli yönetici bir kullanıcının üyelik paketini sildi! Üyelik bilgileri; **ID: $id, Kullanıcı Adı: $zortAdi**");
        } else {
            ...
            sendhook($kullaniciURL, "Kullanıcı Denetleyicisi - Üyelik Paketi Değiştirildi", "**$kadi** isimli yönetici bir kullanıcının üyelik paketini yükseltti! Üyelik bilgileri; **ID: $id, Kullanıcı Adı: $zortAdi**");
        }
...
if ($_POST["sil"] === "sil") {
    ...
    if ($conn->query($sql) === TRUE) {
        sendhook($kullaniciURL, "Kullanıcı Denetleyicisi - Üyelik Silindi", "**$kadi** isimli yönetici bir kullanıcıyı sildi! Üyelik bilgileri; **ID: $id, Kullanıcı Adı: $zortAdi**");
        header('location: /users');
    }
}
