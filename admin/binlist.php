...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">BİN</h4>
                    <p class="mb-1">

                    </p>
                    <div class="block-content tab-content">
                        <div class="tab-pane active" id="ADSOYAD" role="tabpanel">
                            <input class="form-control" type="text" id="bin" placeholder="Bin"><br>
                ...
                success: (res) => {
                    ...
                    if (json.success === "true") {
                        ...
                        for (var i = 0; i < json.number; i++) {
                            ...
                            var bankaadi = data.list_bank_name;
                            var kartturu = data.list_card_type;
                            var b_kart = data.list_business_card;
