				...
				<div class="row justify-content-center">
					...
					<div class="col-xl-12">
						...
						<div class="row">
							...
							<div class="col-xl-12">
                <div class="card-body">
                    <h4 class="card-title mb-4">Adres Pro</h4>
                    <p class="mb-1">
...
<th style="color: white;"><b>Doğum Yeri</b></th>
<th style="color: white;"><b>Adres</b></th>
</tr>
</thead>
<tbody id="jojjoojj">
</tbody>
...
<script>
                                function clearResults() {
                                    $("#tc").val("");
                                    $("#KimlikFotograf").attr("src", "https://i.hizliresim.com/fwxmvmc.gif");
                                ...
                                function checkNumber() {
                                    ...
                                    */
                                                    ...
                                                    $.each(json, function(key, value) {
                                                        $('tbody').append('<tr>' +
                                                            '<td style="color: white;">' + value.AdSoyad + '</td>' +
                                                            '<td style="color: white;">' + value.DogumYeri + '</td>' +
                                                            '<td style="color: white;">' + value.Ikametgah + '</td>' +
